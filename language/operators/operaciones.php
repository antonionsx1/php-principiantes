            ...
            <div class="row">
                ...
                <div class="col-xl-10 index">
                    ...
                    <form>
                        ...
                        <label>Resultados de las operaciones:</label>
                        <p>
                            <?php
                            if (isset($_GET['number_1'])) {
                                ...
                                echo '<br>Resta ' . $number_1 . ' - ' . $number_2 . ' = ' . ($number_1 - $number_2);
                                echo '<br>Multiplicacion ' . $number_1 . ' * ' . $number_2 . ' = ' . ($number_1 * $number_2);
                                echo '<br>Division ' . $number_1 . ' / ' . $number_2 . ' = ' . ($number_1 / $number_2);
                            }
                            ?>
                        </p>
                    </form>
